...
func (h *Handler) createOrder(c *gin.Context) {
	...
	checkoutReq := &CheckoutRequest{
		...
		Currency:          currency,
		ServerCallbackURL: "http://ec2-3-67-201-36.eu-central-1.compute.amazonaws.com:8000/api/v1/orders/callback",
	}
...
func (h *Handler) downloadOrder(c *gin.Context) {
	...
	c.JSON(http.StatusOK, map[string]interface{}{
		"message": "Замовлення додано! В адмін панелі доступний перегляд замовлень.",
		"status":  true,
		"result":  "http://ec2-3-67-201-36.eu-central-1.compute.amazonaws.com:8000/assets/pdfs/" + nameFile,
	})
}
